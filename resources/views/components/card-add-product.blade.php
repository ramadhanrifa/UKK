<div class="flex justify-center items-center w-full">
    <div class="p-8 justify-items-center items-center justify-center  rounded border border-gray-200">
        <h1 class="font-medium text-3xl">Tambah Produk</h1>
        <form>
            <div class="mt-8 grid lg:grid-cols-2 gap-4 w-full">
                ...
                <div> <label for="email" class="text-sm text-gray-700 block mb-1 font-medium">Gambar Produk
                        Adress</label>
                    <input type="file" name="image" id="file"
                        class="bg-gray-100 border border-gray-200 rounded py-1 px-8 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
                </div>
                <div> <label for="job" class="text-sm text-gray-700 block mb-1 font-medium">Harga</label>
                    <input type="text" name="job" id="job"
                        class="bg-gray-100 border border-gray-200 rounded py-1 px-8 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"
                        placeholder="1000" />
                </div>
                <div> <label for="brithday" class="text-sm text-gray-700 block mb-1 font-medium">Stok</label>
