<div class="flex flex-col flex-1">
    <div class="flex flex-1">
        <div class="flex w-full flex-col items-center justify-center rounded-lg border border-gray-200 p-5">
            <div> <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 fill-current text-gray-500" viewBox="0 0 24 24">
            ...
            <div class="mt-5 text-center">
                ...
                <p class="mx-auto mt-4 lg:w-1/2 text-gray-500">
                    Penjualan hari ini adalah <span class="font-semibold">0</span>
                </p>
            </div>
            <button
